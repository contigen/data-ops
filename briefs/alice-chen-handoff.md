...
- **Gap Score**: 100/100
- **Gaps Addressed**: UNDOCUMENTED, NO INSTITUTIONAL MEMORY, NO QUALITY CHECKS, UNDOCUMENTED + CONSUMERS, TRIBAL NAME, NO GLOSSARY TERMS

### Rescued Documentation
**Q**: What specific criteria define `orders_v3_FINAL` as final for its downstream consumers?
